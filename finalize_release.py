...
def main() -> int:
    ...
    parser.add_argument("--update-metadata", required=True, type=Path)
    parser.add_argument("--subtitle-manifest", required=True, type=Path)
    parser.add_argument("--public-key", required=True, type=Path)
    parser.add_argument("--output-root", required=True, type=Path)
    arguments = parser.parse_args()
    latest, signature = finalize_release(
